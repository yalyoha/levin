...
<!-- =========================
   STYLESHEETS 
============================== --><?php $css = new CssMinifier; echo $css->
</head>
<body>
<p>tagLink();  ?&gt;
<style>
...
</style><link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700&amp;subset=cyrillic"></p>
<!-- =========================
     NAVBAR 
============================== -->
...
<div class="container">
    ...
    <nav class="collapse navbar-collapse" id="main-navigation"><ul class="nav navbar-nav navbar-right fog-navbar-nav">
<li><a href="#service">
          <?php Text::here('menu-item-1'); ?></a></li>
        <li><a href="#app-description">
          <?php Text::here('menu-item-2'); ?></a></li>
        <li><a href="#pricing-table">
          <?php Text::here('menu-item-3'); ?></a></li>
        <li><a href="#testimonials">
          <?php Text::here('menu-item-4'); ?></a></li>
        <li><a href="#contact">
          <?php Text::here('menu-item-5'); ?></a></li>
      </ul></nav>
</div>
</header><!-- =========================
     SERVICE HOME - 1
============================== --><section class="home image-bg service-home-1" id="home"><div class="overlay">
    <div class="container">
      <div class="home-content text-center">
        ...
        <p class="sub-title">
          <?php Text::here('main-caption-1'); ?></p>
        <div class="mt-60">
...
============================== --><!-- =========================
     SERVICES 
============================== --><section class="service service-1" id="service"><div class="container"> 
    <!-- SECTION HEADING -->
    <div class="row">
...
<h2 class="title-text">
          ...
          <p class="sub-title">
            <?php Text::here('service-sub-title'); ?></p>
        </header>
</div>
    </div>
    <!-- /END SECTION HEADING -->
	...
	<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter left, move 40px, over 1s">
        <div class="service-item text-center">
          <?php Image::here('testimonials-1', 251, 251); ?><h4 class="title-text">
            <?php Text::here('testimonials-2'); ?>
</h4>
          <p>
            <?php Text::here('testimonials-3'); ?></p>
        </div>
      
	</div>
	<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter bottom, move 40px, over 1s, wait 0.5s">
        <div class="service-item text-center">
          <?php Image::here('testimonials-4', 251, 251); ?><h4 class="title-text">
            <?php Text::here('testimonials-5'); ?>
</h4>
          <p>
            <?php Text::here('testimonials-6'); ?></p>
        </div>
      
	</div>
	<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter right, move 40px, over 1s">
        <div class="service-item text-center">
          <?php Image::here('testimonials-7', 251, 251); ?><h4 class="title-text">
            <?php Text::here('testimonials-8'); ?>
</h4>
          <p>
            <?php Text::here('testimonials-9'); ?></p>
        </div>
      
	</div>
	<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter left, move 40px, over 1s">
        <div class="service-item text-center">
          <?php Image::here('testimonials-10', 251, 251); ?><h4 class="title-text">
            <?php Text::here('testimonials-11'); ?>
</h4>
          <p>
            <?php Text::here('testimonials-12'); ?></p>
        </div>
      
	</div>
	<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter bottom, move 40px, over 1s, wait 0.5s">
        <div class="service-item text-center">
          <?php Image::here('testimonials-13', 251, 251); ?><h4 class="title-text">
            <?php Text::here('testimonials-14'); ?>
</h4>
          <p>
            <?php Text::here('testimonials-15'); ?></p>
        </div>
     ...
     APP DESCRIPTION - 2
============================== --><section class="app-description app-description-2" id="app-description"><div class="container">
    <div class="row">
...
<i class="icon icon-basic-rss"></i>
        ...
        </header><!-- /.column-heading --><p>
          <?php Text::here('description-text-1'); ?></p>
      </div>
    </div>
  </div>
</section><!-- =========================
     APP FEATURE - 2
============================== --><section class="app-feature app-feature-2" id="app-feature"><div class="container">
    <div class="row">
...
<i class="icon icon-basic-share"></i>
          ...
          <?php Text::here('description-text-2'); ?></p>
      </div>
    </div>
  </div>
</section><!-- =========================
     PRICING TABLE 
============================== --><section class="pricing-table pricing-table-2" id="pricing-table"><div class="container"> 
    <!-- SECTION HEADING -->
    <div class="row">
...
<h2 class="title-text">
          ...
          <p class="sub-title">
            <?php Text::here('pricing-sub-title'); ?></p>
        </header>
</div>
    </div>
    <!-- /END SECTION HEADING -->
...
<h5 class="heading">
            ...
            <div class="pricing"> <span class="rate">
              <?php Text::here('pricing-price-1'); ?></span> <span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span> </div>
          </header>
</div>
        <!-- /.single-table --> 
      </div>
...
<h5 class="heading">
            ...
            <div class="pricing"> <span class="rate">
              <?php Text::here('pricing-price-2'); ?></span> <span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span> </div>
          </header>
</div>
        <!-- /.single-table --> 
      </div>
...
<h5 class="heading">
            ...
            <div class="pricing"> <span class="rate">
              <?php Text::here('pricing-price-3'); ?></span> <span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span> </div>
          </header>
</div>
        <!-- /.single-table --> 
      </div>
     ...
     TESTIMONIALS - 2
============================== --><section class="testimonials image-bg testimonials-2" id="testimonials"><div class="overlay">
    <div class="container"> 
      <!-- SECTION HEADING -->
      <div class="row">
        <div class="col-md-6 col-md-offset-3">
...
<h2 class="title-text">
            ...
            <p class="sub-title">
              <?php Text::here('testimonials-sub-title'); ?></p>
          </header>
</div>
      </div>
      <!-- /END SECTION HEADING -->
      <div id="units3" class="row">
        <div class="col-md-6 mb-45" data-sr="scale up 30%, over 1s">
          <blockquote class="testimonial text-center">
            <p>
              <?php Text::here('testimonials-text-1'); ?></p>
            <cite class="author">
            <?php Text::here('testimonials-author-1'); ?></cite> </blockquote>
        </div>
        <div class="col-md-6 mb-45" data-sr="scale up 30%, over 1s, wait 0.4s">
          <blockquote class="testimonial text-center">
            <p>
              <?php Text::here('testimonials-text-2'); ?></p>
            <cite class="author">
            <?php Text::here('testimonials-author-2'); ?></cite> </blockquote>
        </div>
      </div>
    </div>
  </div>
  <!-- /.overlay --> 
     ...
     COMPANIES 
============================== --><section class="companies" id="companies"><div class="container">
    <h4 class="title-text">
      <?php Text::here('companies-text-1'); ?>
</h4>
    <p>
      <?php Text::here('companies-text-2'); ?></p>
  </div>
</section><!-- =========================
     TRIAL DOWNLOAD 
    ...
    <div class="row">
      <div class="col-sm-6 mb-45" data-sr="enter right, move 40px, over 1s, wait 0.4s">
        <div class="get-in-touch">
          ...
          <address>
          <p>
            <?php Text::here('contact-text-2'); ?></p>
          <p>
            <?php Text::here('contact-text-3'); ?></p>
          <p> <span style="font-size: 140%;"><i class="fa fa-phone" aria-hidden="true"></i>
            <?php Text::here('contact-phone-1'); ?></span> </p>
          </address>
        </div>
        <!-- /.get-in-touch -->
...
<footer class="footer"><div class="container">
    <p class="copyright text-center">© <?php echo date("Y"); ?><?php Text::here('copyright-text-1'); ?></p>
