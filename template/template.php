...
<head>
    ...
    <![endif]-->
    <style>
    .home.image-bg { background: url("<?php Image::src('background-image-1',  2560, 788); ?>") center center no-repeat !important; }
    .testimonials.image-bg { background: url("<?php Image::src('background-image-2',  2560, 595); ?>") top center no-repeat !important; }
    </style>
</head>
<body>
<!-- =========================
...
<header class="navbar fog-navbar fog-navbar-light navbar-fixed-top navbar-anim" id="main-nav">
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#home"><img src="images/svg/logo.svg"  alt="company name"></a>
		</div>
		<!-- MAIN NAVIGATION LINKS -->
		<nav class="collapse navbar-collapse" id="main-navigation">
			<ul class="nav navbar-nav navbar-right fog-navbar-nav">
				<li><a href="#service"><?php Text::here('menu-item-1'); ?></a></li>
				<li><a href="#app-description"><?php Text::here('menu-item-2'); ?></a></li>
				<li><a href="#pricing-table"><?php Text::here('menu-item-3'); ?></a></li>
				<li><a href="#testimonials"><?php Text::here('menu-item-4'); ?></a></li>
				<li><a href="#contact"><?php Text::here('menu-item-5'); ?></a></li>
			</ul>
		</nav>
	</div>
</header>
	...
	<div class="overlay">
		<div class="container">
			<div class="home-content text-center">
				<h1><?php Text::here('main-header-1'); ?></h1>
				<p class="sub-title"><?php Text::here('main-caption-1'); ?></p>
				<div class="mt-60">
		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
				<header class="section-heading text-center">
					<h2 class="title-text"><?php Text::here('service-title'); ?></h2>
					<p class="sub-title"><?php Text::here('service-sub-title'); ?></p>
				</header>
			</div>
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter left, move 40px, over 1s">
				<div class="service-item text-center">
					...
					<h4 class="title-text"><?php Text::here('service-title-1'); ?></h4>
					<p><?php Text::here('service-text-1'); ?></p>
				</div>
			</div>
			<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter bottom, move 40px, over 1s, wait 0.5s">
				<div class="service-item text-center">
					...
					<h4 class="title-text"><?php Text::here('service-title-2'); ?></h4>
					<p><?php Text::here('service-text-2'); ?></p>
				</div>
			</div>
			<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter right, move 40px, over 1s">
				<div class="service-item text-center">
					...
					<h4 class="title-text"><?php Text::here('service-title-3'); ?></h4>
					<p><?php Text::here('service-text-3'); ?></p>
				</div>
			</div>
		</div>
	</div>	
		...
		<div class="row">
			...
			<div class="col-md-5 pull-left mb-45" data-sr="enter left, move 40px, over 1s">
				<header class="column-heading">
					...
					<h2 class="title-text"><?php Text::here('description-title-1'); ?></h2>
				</header>	<!-- /.column-heading -->
				<p><?php Text::here('description-text-1'); ?></p>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			...
			<div class="col-md-5 mb-45" data-sr="enter right, move 40px, over 1s">
				<header class="column-heading">
					...
					<h2 class="title-text"><?php Text::here('description-title-2'); ?></h2>
				</header>	<!-- /.column-heading -->
				<p><?php Text::here('description-text-2'); ?></p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-md-offset-3 ">
				<header class="section-heading text-center">
					<h2 class="title-text"><?php Text::here('pricing-title'); ?></h2>
					<p class="sub-title"><?php Text::here('pricing-sub-title'); ?></p>
				</header>
			</div>
		</div> <!-- /END SECTION HEADING -->
		<div class="row">
			<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter left, move 40px, over 1s">
				<div class="single-table">
					<header>
						<h5 class="heading"><?php Text::here('pricing-title-1'); ?></h5>
						<div class="pricing">
							<span class="rate"><?php Text::here('pricing-price-1'); ?></span>
							<span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span>
						</div>
					</header>                   
				</div> <!-- /.single-table -->
			</div>
			<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter bottom, move 40px, over 1s, wait 0.5s">
				<div class="single-table">
					<header>
						<h5 class="heading"><?php Text::here('pricing-title-2'); ?></h5>
						<div class="pricing">
							<span class="rate"><?php Text::here('pricing-price-2'); ?></span>
							<span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span>
						</div>
					</header>
				</div> <!-- /.single-table -->
			...
			<div class="col-md-4 col-md-offset-0 col-sm-8 col-sm-offset-2 mb-45" data-sr="enter right, move 40px, over 1s">
				<div class="single-table">
					<header>
						<h5 class="heading"><?php Text::here('pricing-title-3'); ?></h5>
						<div class="pricing">
							<span class="rate"><?php Text::here('pricing-price-3'); ?></span>
							<span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span>
						</div>
					</header>
				</div> <!-- /.single-table -->
	...
	<div class="overlay">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3">
					<header class="section-heading text-center">
						<h2 class="title-text"><?php Text::here('testimonials-title'); ?></h2>
						<p class="sub-title"><?php Text::here('testimonials-sub-title'); ?></p>
					</header>
				</div>
			</div> <!-- /END SECTION HEADING -->
			<div class="row">
				<div class="col-md-6 mb-45" data-sr="scale up 30%, over 1s">
					<blockquote class="testimonial text-center">
						<p><?php Text::here('testimonials-text-1'); ?></p>
						<cite class="author"><?php Text::here('testimonials-author-1'); ?></span></cite>
					</blockquote>
				</div>
				<div class="col-md-6 mb-45" data-sr="scale up 30%, over 1s, wait 0.4s">
					<blockquote class="testimonial text-center">
						<p><?php Text::here('testimonials-text-2'); ?></p>
						<cite class="author"><?php Text::here('testimonials-author-2'); ?></span></cite>
					</blockquote>
				</div>
			</div>
		</div>
...
<section class="companies" id="companies">
	<div class="container">
		<h4 class="title-text"><?php Text::here('companies-text-1'); ?></h4>
		<p><?php Text::here('companies-text-2'); ?></p>
	</div>
</section>
<!-- =========================
     TRIAL DOWNLOAD 
	...
	<div class="overlay">
		<div class="container text-center">
			...
			<header class="section-heading">
				<h2 class="title-text"><?php Text::here('action-text-1'); ?></h2>
			</header> <!-- /END SECTION HEADING -->
			<p class="info"><?php Text::here('action-text-2'); ?></p>
		</div>
	</div>	<!-- /.overlay -->
</section>
<!-- =========================
		...
		<div class="row">
			<div class="col-sm-6 mb-45" data-sr="enter right, move 40px, over 1s, wait 0.4s">
				<div class="get-in-touch">
					<h5 class="title-text"><?php Text::here('contact-text-1'); ?></h5>
					<address>
						<p><?php Text::here('contact-text-2'); ?></p>
						<p><?php Text::here('contact-text-3'); ?></p>
						<p class="phone"><?php Text::here('contact-phone-1'); ?></p>
					</address>
				</div> <!-- /.get-in-touch -->	
				<div class="get-in-touch">										
			...
			<div class="col-sm-6 mb-45" data-sr="enter right, move 40px, over 1s">
				<div class="get-in-touch">
					<h5 class="title-text"><?php Text::here('contact-text-4'); ?></h5>
...
<footer class="footer">
	<div class="container">
		<p class="copyright text-center">&copy; <?php echo date("Y"); ?> <?php Text::here('copyright-text-1'); ?></p>
	</div>
</footer>
<!-- =========================
     SCRIPTS 
...
<? if (isset($_GET['edit'])) { ?>
<div id="control"><i class="fa fa-cogs fa-2x" aria-hidden="true"></i></div>
