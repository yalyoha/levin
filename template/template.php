...
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="service-item text-center">
          ...
          <p>
            <?php Text::here('[serviceUnit-3]'); ?></p>
        </div>
	</div>
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="service-item text-center">
          <?php Image::here('[serviceUnit-4]', 251, 251); ?><h4 class="title-text">
            <?php Text::here('[serviceUnit-5]'); ?>
</h4>
          <p>
            <?php Text::here('[serviceUnit-6]'); ?></p>
        </div>
	</div>
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
        <div class="service-item text-center">
          <?php Image::here('[serviceUnit-7]', 251, 251); ?><h4 class="title-text">
            <?php Text::here('[serviceUnit-8]'); ?>
</h4>
          <p>
            <?php Text::here('[serviceUnit-9]'); ?></p>
        </div>
	</div>
</div>
  </div>
...
<h5 class="heading">
            ...
            <div class="pricing"> <span class="rate">
              <?php Text::here('[pricingUnit-2]'); ?></span> <span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span> </div>
          </header>
</div>
        <!-- /.single-table --> 
      </div>
...
<h5 class="heading">
            ...
            <div class="pricing"> <span class="rate">
              <?php Text::here('[pricingUnit-4]'); ?></span> <span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span> </div>
          </header>
</div>
        <!-- /.single-table --> 
      </div>
...
<h5 class="heading">
            ...
            <div class="pricing"> <span class="rate">
              <?php Text::here('[pricingUnit-6]'); ?></span> <span class="period"><i class="fa fa-rub" aria-hidden="true"></i></span> </div>
          </header>
</div>
        <!-- /.single-table --> 
      </div>
...
<h2 class="title-text">
      ...
      <div id="testimonialUnit" class="restcruct row"><div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
          <blockquote class="testimonial text-center">
            ...
            <cite class="author">
            <?php Text::here('[testimonialUnit-2]'); ?></cite> </blockquote>
        </div>
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
          <blockquote class="testimonial text-center">
            <p>
              <?php Text::here('[testimonialUnit-3]'); ?></p>
            <cite class="author">
            <?php Text::here('[testimonialUnit-4]'); ?></cite> </blockquote>
        </div>
<div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
          <blockquote class="testimonial text-center">
            <p>
              <?php Text::here('[testimonialUnit-5]'); ?></p>
            <cite class="author">
            <?php Text::here('[testimonialUnit-6]'); ?></cite> </blockquote>
        </div>
</div>
    </div>
  </div>
...
<footer class="footer"><div class="container">
    ...
    <p class="powered text-center"><small>Создание сайта :: <span class="uc">Frankie Makers</span><span> | </span>Управление сайтом :: Levin CMS</small></p>
  </div>
</footer><!-- =========================
     SCRIPTS 
